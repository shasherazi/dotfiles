...
alias nxc='tmux has-session 2>/dev/null || tmux new-session -d -c "$HOME/.config/nixos"; tmux split-window -h -p 36 -c "$HOME/.config/nixos" \; select-pane -L \; send-keys "$EDITOR" Enter \; attach'
